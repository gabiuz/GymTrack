      ...
      <div className="w-full max-w-100">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 font-inter">
            {mode === "login" ? "Owner — sign in to continue" : "Reset your password"}
          </p>
        </div>
        ...
        {mode === "login" && (
          <form onSubmit={handleLogin} className="bg-white border border-black/8 rounded-xl p-7 shadow-[0_2px_16px_rgba(0,0,0,0.06)]">
            ...
            <div className="mb-2">
              <label className="block text-[11px] font-semibold text-gray-500 tracking-widests uppercase mb-1.5 font-inter">
                Password
              </label>
              <input
                id="owner-password"
            ...
            <form onSubmit={handleFpReset} className="flex flex-col gap-4">
              <div>
                ...
                <div className="relative">
                  <input id="owner-fp-newpw" type={fpShowNew ? "text" : "password"} value={fpNewPw} onChange={(e) => setFpNewPw(e.target.value)} placeholder="Min. 6 characters" required
              ...
              <div>
                ...
                <div className="relative">
                  <input id="owner-fp-confirmpw" type={fpShowConfirm ? "text" : "password"} value={fpConfirmPw} onChange={(e) => setFpConfirmPw(e.target.value)} placeholder="Re-enter password" required
                    className="w-full bg-gray-50 border border-black/14 rounded-lg px-3.5 pr-9 py-2.5 text-sm text-gym-dark font-inter outline-none focus:border-gym-lime transition-colors" />
