          ...
          {detailLoading || !detail ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <div className="text-[11px] font-semibold text-gray-400 tracking-widests uppercase mb-2.5 font-inter">Contact</div>
                ...
                <div className="mt-4 lg:mt-0">
                  <div className="text-[11px] font-semibold text-gray-400 tracking-widests uppercase mb-2.5 font-inter">Membership</div>
